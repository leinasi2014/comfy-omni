...
| 完整 Ref2VA 原生转换（服务器已验证：636.593 s；932 个 action、532 个输出 tensor、10 个 shard；40,225,668,192 字节 tensor payload） | 已验收的真实模型切片 | [`docs/evidence/ref2va-full-conversion-25ceccdd5468.md`](../docs/evidence/ref2va-full-conversion-25ceccdd5468.md) |
